...
require_workflow_packages(c("AlgDesign", "openxlsx", "tibble", "xml2", "zip"))
...
saveRDS(full_design, file.path(path_outputs, "full_factorial_design.rds"))
save_full_design_to_excel(
  full_design,
  file.path(path_outputs, "full_factorial_design.xlsx")
)
